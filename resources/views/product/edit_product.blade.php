    ...
    <!-- BEGIN VALIDATION STATES-->
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-body"  style="background-color: #f7ffef;">
                ...
                {!! Form::open(['url' => '/Product/'.$product->id , 'method' => 'POST', 'enctype'=>'multipart/form-data','file'=>true ]) !!}
                {{ csrf_field() }}
                <div class="form-body">
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <select name="item" id="item" class="form-control" required >
                                <option value="">{{ $product->item_name }}</option>
                    ...
                    <div class="form-group form-md-line-input">
                        {!! Form::label('form_control_1', 'Brand Name' ,  ['class' => 'col-md-2 control-label',  ]) !!}
                        <div class="col-md-10">
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <input value="{{ $product->product_name }}" type="text" class="form-control" name="product_name" placeholder="Product Name" required>
                        </div>
                    </div>
                    <div class="form-group form-md-line-input">
                        {!! Form::label('form_control_1', 'Product Price' ,  ['class' => 'col-md-2 control-label',  ]) !!}
                        <div class="col-md-10">
                            <input value="{{ $product->product_price }}"type="text" class="form-control" name="product_price" placeholder="Product Price" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <textarea name="details"  rows="8" cols="112"  required>{{ $product->details }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <input value="{{ $product->product_stock}}" type="text" class="form-control" name="product_stock" placeholder="Product Stock" required>
                        </div>
                    </div>
