                    ...
                    <div class="underlined push-down-20">
                        <div class="row">
                            <div class="span4">
                                ...
                                <h3><span class="light">Search : </span>
                                    @if(isset($query))
                                        <b style="color: #e85a8c;"> " {{ $query }} " </b>
                                    @endif
                                </h3>
                            </div>
                                    ...
                                    <div class="product" style="border: 1px solid #d8d8d8; background-color: #fff;">
                                        {{--<div class="product-inner">--}}
                                            ...
                                            <div class="main-titles no-margin">
                                                ...
                                                <h5 class="no-margin isotope--title" style="text-align: center; font-size: 13px;">{{ $singlePro->product_name }}</h5>
                                            </div>
