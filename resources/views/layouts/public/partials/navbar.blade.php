                                        ...
                                        <div class="span3">
                                            @foreach($FeaPro as $FP)
                                                <a href="{{ url('/Products/'.$FP->id.'/'.$FP->category) }}">
                                                    <img src="{{ $FP->img }}" alt="woman in shari" style="width: 265px; height: 130px; border: 1px solid #d8d8d8;"></a>
                                                <h5 style=" padding-bottom: 10px;"><span class="light">Feature</span> {{ $FP->category }}</h5>
                                            @endforeach
                                        </div>
                    ...
                    <div class="cart-container" id="cartContainer">
                        ...
                        <div class="open-panel">
                            ...
                            <div class="proceed">
                                @if (Route::has('login'))
                                @if (Auth::check())
                                <a href="{{ url('/checkoutStep2') }}" class="btn btn-danger pull-right bold higher">CHECKOUT <i class="icon-shopping-cart"></i></a>
