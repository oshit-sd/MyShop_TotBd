    ...
    <div class="col-md-6" >
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-body"  style="background-color: #f7ffef;">
                ...
                @endif
                <form  id="registration_form" role="form" method="POST" action="{{ url('/Item/'.$item->id) }}">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <a href="/Item" style="margin-left: 15px; font-weight: bold; border-bottom: 1px solid">List Main Menu</a>

                        <div class="form-group form-md-line-input">
                            {!! Form::label('form_control_1', 'Item Name' ,  ['class' => 'col-md-4 control-labe', ]) !!}
                            <div class="col-md-8">
                                <input id="mmenu" type="text" value="{{ $item->item_name }}" class="form-control" name="item_name" placeholder="Item Name" required autofocus>
                            </div>
                        </div>
                    </div>
