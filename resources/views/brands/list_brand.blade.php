    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <a href="/Brand/create" style="font-weight: bold; border-bottom: 1px solid">Add Brand</a> |
                <a href="#" style="font-weight: bold; border-bottom: 1px solid">Trush</a>
                <br><br>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        <li>
                                            <a href="{{ '/Brand/'.$data->id.'/edit' }}">
                                            <i class="btn btn-primary btn-sm">Edit</i>  </a>
                                        </li>
                                        <li><a href="">
                                            {!! Form::open(['url' => '/Brand/'.$data->id , 'method' => 'DELETE']) !!}
