            ...
            <div class="row">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li><span class="icon-chevron-right"></span></li>
                        <li>
                        <a href="{{ url('ItemProduct/'.$lc->item_name) }}">{{ $lc->item_name }}</a>
                        </li>
                        <li><span class="icon-chevron-right"></span></li>
                        <li>
                        <a href="{{ url('CategoryProduct/'.$lc->category) }}">{{ $lc->category }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <section class="span9">
                    ...
                    <div class="underlined push-down-20">
                        <div class="row">
                            <div class="span4">
                                @foreach($linkCate as $lc)
                                <h3><span class="light">All</span> {{ $lc->category }}</h3>
                                    @endforeach
                            </div>
